...
\[
\boxed{
\text{What is the relation doing the transfer?}
}
\]
...
\[
\boxed{
\text{every asserted relation must be declared, typed, and assigned preservation conditions.}
}
\]
...
\[
\text{entropy}\Rightarrow\text{geometry},
\]

\[
\text{recoverability}\Rightarrow\text{causality},
\]

\[
\text{prediction}\Rightarrow\text{explanation},
\]

\[
\text{local compatibility}\Rightarrow\text{global object},
\]

\[
\text{residual}\Rightarrow\text{dynamics},
\]

\[
\text{order + number}\Rightarrow\text{geometry},
\]

\[
\text{formal action-like evaluator}\Rightarrow\text{physical action}.
\]
...
\[
\boxed{
\text{To state an object is to incur a path obligation.}
}
\]
...
\[
\boxed{
\text{declare the relation, then test the relation.}
}
\]
...
\[
\boxed{
\text{nothing may transfer, preserve, compare, explain, or exist-as-object by an undeclared relation.}
}
\]
...
\[
\boxed{
X-(\mathfrak B,\mathfrak K)-Y'_{\varepsilon}\subseteq Y.
}
\]
...
\[
\boxed{
\text{mediation / bridge}
}
\]

\[
\boxed{
\text{visibility / target-readout}
}
\]
...
\[
\text{what relation makes a distinction visible, stable, and transferable?}
\]
...
\[
\boxed{
\text{objecthood}=\text{compatible charted organization}.
}
\]
...
\[
\text{did the transfer work?}
\]

It asks:

\[
\text{what exactly failed to be preserved?}
\]

and:

\[
\text{what relation would be needed to repair it?}
\]
...
\text{entropy}
-
\text{dictionary / region class / area law / code subspace / order-scale bridge}
-
\text{geometry}.
\]
...
\[
\text{recoverability gives causality}
\]
...
\text{recoverability}
-
\text{intervention / counterfactual / temporal-order bridge}
-
\text{causality}.
\]
...
\[
\text{local compatibility gives objecthood}
\]

becomes:

\[
\text{local organizations}
-
\text{gluing / transport / holonomy bridge}
-
...
\[
\text{formal Lorentzian skeleton gives physical spacetime}
\]
...
\[
\boxed{
\text{what bridge preserves the target distinctions?}
}
\]
...
\[
\boxed{
\text{show the bridge, test the bridge, learn from the failure.}
}
\]
...
\[
\boxed{
\text{foundational inference must declare the relation doing the work.}
}
\]
...
\[
\boxed{
\text{declare the relation, test the relation, calibrate the approximation, or do not use the relation.}
}
\]
